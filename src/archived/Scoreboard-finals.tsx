...
const ScoreboardFinals = ({ matchId, gameNumber, ui, setMatchId, setGameNumber }: { matchId: string, gameNumber: string, ui: boolean, setGameNumber: (newGameNumber: string) => void, setMatchId: React.Dispatch<React.SetStateAction<string>>, }) => {
